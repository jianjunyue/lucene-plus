...
package org.lucene.plus.knn.index.codec.KNN80Codec;

import org.lucene.plus.knn.index.SpaceTypes;
...
import org.lucene.plus.knn.index.util.KNNConstants;
import org.lucene.plus.knn.index.util.NmsLibVersion;
import org.lucene.plus.knn.index.v206.KNNIndex;
...
class KNN80DocValuesConsumer extends DocValuesConsumer implements Closeable {
    ...
    public void addKNNBinaryField(FieldInfo field, DocValuesProducer valuesProducer) throws IOException {
        ...
        if (field.attributes().containsKey(KNNVectorFieldMapper.KNN_FIELD)) {
            ...
            System.out.println("tempIndexPath:"+tempIndexPath);
