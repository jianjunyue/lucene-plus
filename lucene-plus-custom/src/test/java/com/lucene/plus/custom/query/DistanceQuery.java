...
public class DistanceQuery extends Query {
	  ...
	  public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
	    ...
	    return (Weight)new ConstantScoreWeight(this, 1f) {
	        public Scorer scorer(LeafReaderContext context) throws IOException {
	          LeafReader reader = context.reader();
	          FieldInfos fs=   reader.getFieldInfos();
	          PointValues values = reader.getPointValues(DistanceQuery.this.field);
	          if (values == null)
	            return null; 
	          ...
	          return (Scorer)new ConstantScoreScorer((Weight)this, score(), ScoreMode.TOP_SCORES, result.build().iterator());
	        }
