...
import org.lucene.plus.test.temp.KNNFunValueSouce;
...
//			FunctionRangeQuery functionQuery = new FunctionRangeQuery(new FunValueSouce("bdvf"),1,10,true,true);
			FunctionRangeQuery functionQuery = new FunctionRangeQuery(new KNNFunValueSouce("test_vector"),1,10,true,true);
