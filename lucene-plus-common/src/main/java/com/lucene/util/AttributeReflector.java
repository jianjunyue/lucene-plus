...
public interface AttributeReflector {
   ...
   * E.g., an invocation of {@link com.lucene.analysis.tokenattributes.CharTermAttributeImpl#reflectWith}
   * would call this method once using {@code com.lucene.analysis.tokenattributes.CharTermAttribute.class}
