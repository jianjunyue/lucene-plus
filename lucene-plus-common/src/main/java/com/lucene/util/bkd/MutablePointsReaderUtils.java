...
import com.lucene.util.IntroSelector;
import com.lucene.util.IntroSorter;
import com.lucene.util.MSBRadixSorter;
import com.lucene.util.RadixSelector;
import com.lucene.util.Selector;
...
public final class MutablePointsReaderUtils {
  ...
  public static void sort(int maxDoc, int packedBytesLength,
    ...
    new MSBRadixSorter(packedBytesLength + (bitsPerDocId + 7) / 8) {
      ...
      @Override
      protected com.lucene.util.Sorter getFallbackSorter(int k) {
