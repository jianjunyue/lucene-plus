 ...
 * abstract class {@link com.lucene.search.similarities.Similarity} serves
 ...
 * 
 * <p>{@link com.lucene.search.similarities.BM25Similarity} is an optimized
 * implementation of the successful Okapi BM25 model.
 *
 * <p>{@link com.lucene.search.similarities.ClassicSimilarity} is the original Lucene
 * scoring function. It is based on the
 * <a href="http://en.wikipedia.org/wiki/Vector_Space_Model">Vector Space Model</a>. For more
 * information, see {@link com.lucene.search.similarities.TFIDFSimilarity}.
 * 
 * <p>{@link com.lucene.search.similarities.SimilarityBase} provides a basic
 ...
 * {@link com.lucene.search.similarities.SimilarityBase}:
 * 
 * <a name="framework"></a>
 * <ul>
 *   <li>Amati and Rijsbergen's {@linkplain com.lucene.search.similarities.DFRSimilarity DFR} framework;</li>
 *   <li>Clinchant and Gaussier's {@linkplain com.lucene.search.similarities.IBSimilarity Information-based models}
 *     for IR;</li>
 *   <li>The implementation of two {@linkplain com.lucene.search.similarities.LMSimilarity language models} from
 *   Zhai and Lafferty's paper.</li>
 *   <li>{@linkplain com.lucene.search.similarities.DFISimilarity Divergence from independence} models as described
 *   in "IRRA at TREC 2012" (Dinçer).
 *   <li>
 * </ul>
 * 
 * Since {@link com.lucene.search.similarities.SimilarityBase} is not
 * optimized to the same extent as
 * {@link com.lucene.search.similarities.ClassicSimilarity} and
 * {@link com.lucene.search.similarities.BM25Similarity}, a difference in
 ...
 *     and could set BM25's {@link com.lucene.search.similarities.BM25Similarity#BM25Similarity(float,float) b}
 *     parameter to {@code 0}.
 * 
 * <p>To change {@link com.lucene.search.similarities.Similarity}, one must do so for both indexing and
 ...
 * 
 * <p>To make this change, implement your own {@link com.lucene.search.similarities.Similarity} (likely
 *     you'll want to simply subclass {@link com.lucene.search.similarities.SimilarityBase}), and
 *     then register the new class by calling
 *     {@link com.lucene.index.IndexWriterConfig#setSimilarity(Similarity)}
 *     before indexing and
 *     {@link com.lucene.search.IndexSearcher#setSimilarity(Similarity)}
 *     before searching.
 * 
 * <h3>Tuning {@linkplain com.lucene.search.similarities.BM25Similarity}</h3>
 * <p>{@link com.lucene.search.similarities.BM25Similarity} has
 ...
 * </ul> 
 *
 * <h3>Extending {@linkplain com.lucene.search.similarities.SimilarityBase}</h3>
 * <p>
 * The easiest way to quickly implement a new ranking method is to extend
 * {@link com.lucene.search.similarities.SimilarityBase}, which provides
 * basic implementations for the low level . Subclasses are only required to
 * implement the {@link com.lucene.search.similarities.SimilarityBase#score(BasicStats, double, double)}
 * and {@link com.lucene.search.similarities.SimilarityBase#toString()}
 * methods.
 * 
 * <p>Another option is to extend one of the <a href="#framework">frameworks</a>
 * based on {@link com.lucene.search.similarities.SimilarityBase}. These
 * Similarities are implemented modularly, e.g.
 * {@link com.lucene.search.similarities.DFRSimilarity} delegates
 * computation of the three parts of its formula to the classes
 * {@link com.lucene.search.similarities.BasicModel},
 * {@link com.lucene.search.similarities.AfterEffect} and
 * {@link com.lucene.search.similarities.Normalization}. Instead of
 * subclassing the Similarity, one can simply introduce a new basic model and tell
 * {@link com.lucene.search.similarities.DFRSimilarity} to use it.
 * 
 */
