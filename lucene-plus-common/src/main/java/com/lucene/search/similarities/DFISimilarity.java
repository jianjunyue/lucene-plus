 ...
 *
 * @lucene.experimental
 * @see com.lucene.search.similarities.IndependenceStandardized
 * @see com.lucene.search.similarities.IndependenceSaturated
 * @see com.lucene.search.similarities.IndependenceChiSquared
 */
