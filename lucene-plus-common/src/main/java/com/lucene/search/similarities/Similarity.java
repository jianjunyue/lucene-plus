 ...
 * be later accessible via {@link com.lucene.index.LeafReader#getNormValues(String)}.
 ...
 * accessed at query-time with {@link com.lucene.index.LeafReader#getNumericDocValues(String)}.
 ...
 * When {@link IndexSearcher#explain(com.lucene.search.Query, int)} is called, queries consult the Similarity's DocScorer for an 
