...
import com.lucene.index.FieldInvertState;
import com.lucene.index.IndexOptions;
import com.lucene.search.CollectionStatistics;
import com.lucene.search.Explanation;
import com.lucene.search.IndexSearcher;
import com.lucene.search.TermStatistics;
import com.lucene.util.SmallFloat;
 ...
 *      {@link com.lucene.search.similarities.ClassicSimilarity#tf(float) ClassicSimilarity} is:
 *
 *      <br>&nbsp;<br>
 ...
 *        <tr>
 *          <td valign="middle" align="right" rowspan="1">
 *            {@link com.lucene.search.similarities.ClassicSimilarity#tf(float) tf(t in d)} &nbsp; = &nbsp;
 *          </td>
 ...
 *      {@link com.lucene.search.similarities.ClassicSimilarity#idf(long, long) ClassicSimilarity} is:
 *
 *      <br>&nbsp;<br>
 ...
 *            {@link com.lucene.search.similarities.ClassicSimilarity#idf(long, long) idf(t)}&nbsp; = &nbsp;
 *          </td>
 *          <td valign="middle" align="center">
 *            1 + log <big>(</big>
 *          </td>
 ...
 *      {@link com.lucene.search.BoostQuery#BoostQuery(com.lucene.search.Query, float) BoostQuery}.
 *      Notice that there is really no direct API for accessing a boost of one term in a multi term query,
 *      but rather multi terms are represented in a query as multi
 *      {@link com.lucene.search.TermQuery TermQuery} objects,
 *      and so the boost of a term in the query is accessible by calling the sub-query
 *      {@link com.lucene.search.BoostQuery#getBoost() getBoost()}.
 *      <br>&nbsp;<br>
 *    </li>
 *
 *    <li>
 ...
 * </ol>
 *
 * @see com.lucene.index.IndexWriterConfig#setSimilarity(Similarity)
...
public abstract class TFIDFSimilarity extends Similarity {
   ...
   * {@link com.lucene.index.IndexReader#numDocs() IndexReader#numDocs()} because also 
