 ...
 * 
 *  <li> {@link #getLeafComparator(com.lucene.index.LeafReaderContext)} Invoked
...
public abstract class FieldComparator<T> {
   ...
   * {@link com.lucene.index.LeafReaderContext}. All docIDs supplied to
   ...
   *  com.lucene.index.LeafReader#getNumericDocValues} and sorts by ascending value */
   ...
   *  com.lucene.index.LeafReader#getNumericDocValues(String)} and sorts by ascending value */
   ...
   *  com.lucene.search.FieldComparator.TermValComparator}, but it first resolves the string
   *  to their relative ordinal positions (using the index
   *  returned by {@link com.lucene.index.LeafReader#getSortedDocValues(String)}), and
   *  does most comparisons using the ordinals.  For medium
   *  to large results, this comparator will be much faster
   *  than {@link com.lucene.search.FieldComparator.TermValComparator}.  For very small
