...
import com.lucene.store.NIOFSDirectory;
...
public class IndexSearcher {
   ...
   * will be one {@link LeafSlice} per leaf ({@link com.lucene.index.LeafReaderContext}).
   */
   ...
   * @param sort The {@link com.lucene.search.Sort} object
   * @return The top docs, sorted according to the supplied {@link com.lucene.search.Sort} instance
