 ...
 * <h2>Search Basics</h2>
 * <p>
 * Lucene offers a wide variety of {@link com.lucene.search.Query} implementations, most of which are in
 * this package, its subpackage ({@link com.lucene.search.spans spans},
 ...
 * com.lucene.search.IndexSearcher#search(Query,int)}.
 * <p>
 * Once a Query has been created and submitted to the {@link com.lucene.search.IndexSearcher IndexSearcher}, the scoring
 * process begins. After some infrastructure setup, control finally passes to the {@link com.lucene.search.Weight Weight}
 * implementation and its {@link com.lucene.search.Scorer Scorer} or {@link com.lucene.search.BulkScorer BulkScorer}
 ...
 * <h2>Query Classes</h2>
 * <h3>
 *     {@link com.lucene.search.TermQuery TermQuery}
 * </h3>
 * 
 * <p>Of the various implementations of
 *     {@link com.lucene.search.Query Query}, the
 *     {@link com.lucene.search.TermQuery TermQuery}
 *     is the easiest to understand and the most often used in applications. A
 *     {@link com.lucene.search.TermQuery TermQuery} matches all the documents that contain the
 *     specified
 *     {@link com.lucene.index.Term Term},
 *     which is a word that occurs in a certain
 *     {@link com.lucene.document.Field Field}.
 *     Thus, a {@link com.lucene.search.TermQuery TermQuery} identifies and scores all
 *     {@link com.lucene.document.Document Document}s that have a 
 *         {@link com.lucene.document.Field Field} with the specified string in it.
 *     Constructing a {@link com.lucene.search.TermQuery TermQuery}
 *     is as simple as:
 *     <pre class="prettyprint">
 *         TermQuery tq = new TermQuery(new Term("fieldName", "term"));
 *     </pre>In this example, the {@link com.lucene.search.Query Query} identifies all 
 *         {@link com.lucene.document.Document Document}s that have the 
 *         {@link com.lucene.document.Field Field} named <tt>"fieldName"</tt>
 *     containing the word <tt>"term"</tt>.
 * <h3>
 *     {@link com.lucene.search.BooleanQuery BooleanQuery}
 * </h3>
 * 
 * <p>Things start to get interesting when one combines multiple
 *     {@link com.lucene.search.TermQuery TermQuery} instances into a 
 *         {@link com.lucene.search.BooleanQuery BooleanQuery}.
 *     A {@link com.lucene.search.BooleanQuery BooleanQuery} contains multiple
 *     {@link com.lucene.search.BooleanClause BooleanClause}s,
 *     where each clause contains a sub-query ({@link com.lucene.search.Query Query}
 *     instance) and an operator (from 
 *         {@link com.lucene.search.BooleanClause.Occur BooleanClause.Occur})
 *     describing how that sub-query is combined with the other clauses:
 *     <ol>
 * 
 *         <li><p>{@link com.lucene.search.BooleanClause.Occur#SHOULD SHOULD} &mdash; Use this operator when a clause can occur in the result set, but is not required.
 ...
 * 
 *         <li><p>{@link com.lucene.search.BooleanClause.Occur#MUST MUST} &mdash; Use this operator when a clause is required to occur in the result set and should
 *             contribute to the score. Every document in the result set will match all such clauses.</p></li>
 * 
 *         <li><p>{@link com.lucene.search.BooleanClause.Occur#FILTER FILTER} &mdash; Use this operator when a clause is required to occur in the result set but
 *             should not contribute to the score. Every document in the result set will match all such clauses.</p></li>
 * 
 *         <li><p>{@link com.lucene.search.BooleanClause.Occur#MUST_NOT MUST NOT} &mdash; Use this operator when a
 ...
 *     {@link com.lucene.search.BooleanClause BooleanClause}
 *     instances. If too many clauses are added, a {@link com.lucene.search.BooleanQuery.TooManyClauses TooManyClauses}
 *     exception will be thrown during searching. This most often occurs
 *     when a {@link com.lucene.search.Query Query}
 *     is rewritten into a {@link com.lucene.search.BooleanQuery BooleanQuery} with many
 *     {@link com.lucene.search.TermQuery TermQuery} clauses,
 *     for example by {@link com.lucene.search.WildcardQuery WildcardQuery}.
 *     The default setting for the maximum number
 *     of clauses is 1024, but this can be changed via the
 *     static method {@link com.lucene.search.BooleanQuery#setMaxClauseCount(int)}.
 * 
 * <h3>Phrases</h3>
 * 
 ...
 *     <ol>
 *         <li>
 *             <p>{@link com.lucene.search.PhraseQuery PhraseQuery}
 *                 &mdash; Matches a sequence of
 *                 {@link com.lucene.index.Term Term}s.
 *                 {@link com.lucene.search.PhraseQuery PhraseQuery} uses a slop factor to determine
 ...
 *         </li>
 *         <li>
 *             <p>{@link com.lucene.search.MultiPhraseQuery MultiPhraseQuery}
 ...
 *         </li>
 *         <li>
 *             <p>{@link com.lucene.search.spans.SpanNearQuery SpanNearQuery}
 *                 &mdash; Matches a sequence of other
 *                 {@link com.lucene.search.spans.SpanQuery SpanQuery}
 *                 instances. {@link com.lucene.search.spans.SpanNearQuery SpanNearQuery} allows for
 *                 much more
 *                 complicated phrase queries since it is constructed from other 
 *                     {@link com.lucene.search.spans.SpanQuery SpanQuery}
 *                 instances, instead of only {@link com.lucene.search.TermQuery TermQuery}
 *                 instances.</p>
 *         </li>
 *     </ol>
 * 
 * <h3>
 *     {@link com.lucene.search.PointRangeQuery PointRangeQuery}
 * </h3>
 * 
 * <p>The
 *     {@link com.lucene.search.PointRangeQuery PointRangeQuery}
 ...
 *     using a one of the numeric fields ({@link com.lucene.document.IntPoint IntPoint},
 *     {@link com.lucene.document.LongPoint LongPoint}, {@link com.lucene.document.FloatPoint FloatPoint},
 *     or {@link com.lucene.document.DoublePoint DoublePoint}).
 * 
 * <h3>
 *     {@link com.lucene.search.PrefixQuery PrefixQuery},
 *     {@link com.lucene.search.WildcardQuery WildcardQuery},
 *     {@link com.lucene.search.RegexpQuery RegexpQuery}
 * </h3>
 * 
 * <p>While the
 *     {@link com.lucene.search.PrefixQuery PrefixQuery}
 ...
 *     {@link com.lucene.search.WildcardQuery WildcardQuery}.
 *     The {@link com.lucene.search.PrefixQuery PrefixQuery} allows an application
 *     to identify all documents with terms that begin with a certain string. The 
 *         {@link com.lucene.search.WildcardQuery WildcardQuery} generalizes this by allowing
 *     for the use of <tt>*</tt> (matches 0 or more characters) and <tt>?</tt> (matches exactly one character) wildcards.
 *     Note that the {@link com.lucene.search.WildcardQuery WildcardQuery} can be quite slow. Also
 *     note that
 *     {@link com.lucene.search.WildcardQuery WildcardQuery} should
 ...
 *     The {@link com.lucene.search.RegexpQuery RegexpQuery} is even more general than WildcardQuery,
 *     allowing an application to identify all documents with terms that match a regular expression pattern.
 * <h3>
 *     {@link com.lucene.search.FuzzyQuery FuzzyQuery}
 * </h3>
 *
 * <p>A
 *     {@link com.lucene.search.FuzzyQuery FuzzyQuery}
 ...
 *    </ul>
 *    These models can be plugged in via the {@link com.lucene.search.similarities Similarity API},
 ...
 *    change your {@link com.lucene.search.similarities.Similarity Similarity}. Next, it will cover
 ...
 *    implementing your own {@link com.lucene.search.Query Query} class and related functionality.
 ...
 *    {@link com.lucene.search.IndexSearcher#explain(com.lucene.search.Query, int) IndexSearcher.explain(Query, doc)}
 ...
 * <p>In Lucene, the objects we are scoring are {@link com.lucene.document.Document Document}s.
 *    A Document is a collection of {@link com.lucene.document.Field Field}s.  Each Field has
 *    {@link com.lucene.document.FieldType semantics} about how it is created and stored 
 *    ({@link com.lucene.document.FieldType#tokenized() tokenized}, 
 *    {@link com.lucene.document.FieldType#stored() stored}, etc). It is important to note that 
 ...
 *    {@link com.lucene.search.BoostQuery}.</p>
 * 
 * <a name="changingScoring"></a>
 * <h2>Changing Scoring &mdash; Similarity</h2>
 * <h3>Changing the scoring formula</h3>
 * <p>
 * Changing {@link com.lucene.search.similarities.Similarity Similarity} is an easy way to 
 * influence scoring, this is done at index-time with 
 * {@link com.lucene.index.IndexWriterConfig#setSimilarity(com.lucene.search.similarities.Similarity)
 *  IndexWriterConfig.setSimilarity(Similarity)} and at query-time with
 * {@link com.lucene.search.IndexSearcher#setSimilarity(com.lucene.search.similarities.Similarity)
 ...
 * <p>
 * Finally, you can extend the low level {@link com.lucene.search.similarities.Similarity Similarity} directly
 * to implement a new retrieval model.
 * <p>
 * See the {@link com.lucene.search.similarities} package documentation for information
 ...
 * a {@link com.lucene.document.FeatureField FeatureField} with the document at index-time, and then
 ...
 * {@link com.lucene.document.NumericDocValuesField NumericDocValuesField} at index time:
 * <pre class="prettyprint">
 ...
 *     <ol>
 *         <li>
 *             {@link com.lucene.search.Query Query} &mdash; The abstract object representation of the
 *             user's information need.</li>
 *         <li>
 *             {@link com.lucene.search.Weight Weight} &mdash; A specialization of a Query for a given
 *             index. This typically associates a Query object with index statistics that are later used to
 *             compute document scores.
 *         <li>
 *             {@link com.lucene.search.Scorer Scorer} &mdash; The core class of the scoring process:
 *             for a given segment, scorers return {@link com.lucene.search.Scorer#iterator iterators}
 *             over matches and give a way to compute the {@link com.lucene.search.Scorer#score score}
 *             of these matches.</li>
 *         <li>
 *             {@link com.lucene.search.BulkScorer BulkScorer} &mdash; An abstract class that scores
 *       a range of documents.  A default implementation simply iterates through the hits from
 *       {@link com.lucene.search.Scorer Scorer}, but some queries such as
 *       {@link com.lucene.search.BooleanQuery BooleanQuery} have more efficient
 *       implementations.</li>
 *     </ol>
 *     Details on each of these classes, and their children, can be found in the subsections below.
 * <h3>The Query Class</h3>
 *     <p>In some sense, the
 *         {@link com.lucene.search.Query Query}
 ...
 *         {@link com.lucene.search.Query Query} class has several methods that are important for
 *         derived classes:
 *         <ol>
 *             <li>{@link com.lucene.search.Query#createWeight(IndexSearcher,ScoreMode,float) createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost)} &mdash; A
 *                 {@link com.lucene.search.Weight Weight} is the internal representation of the
 *                 Query, so each Query implementation must
 *                 provide an implementation of Weight. See the subsection on <a
 *                     href="#weightClass">The Weight Interface</a> below for details on implementing the Weight
 *                 interface.</li>
 *             <li>{@link com.lucene.search.Query#rewrite(com.lucene.index.IndexReader) rewrite(IndexReader reader)} &mdash; Rewrites queries into primitive queries. Primitive queries are:
 *                 {@link com.lucene.search.TermQuery TermQuery},
 *                 {@link com.lucene.search.BooleanQuery BooleanQuery}, <span
 *                     >and other queries that implement {@link com.lucene.search.Query#createWeight(IndexSearcher,ScoreMode,float) createWeight(IndexSearcher searcher,ScoreMode scoreMode, float boost)}</span></li>
 *         </ol>
 * <a name="weightClass"></a>
 * <h3>The Weight Interface</h3>
 *     <p>The
 *         {@link com.lucene.search.Weight Weight}
 *         interface provides an internal representation of the Query so that it can be reused. Any
 *         {@link com.lucene.search.IndexSearcher IndexSearcher}
 ...
 *         <ol>
 *             <li>
 *                 {@link com.lucene.search.Weight#scorer scorer()} &mdash;
 *                 Construct a new {@link com.lucene.search.Scorer Scorer} for this Weight. See <a href="#scorerClass">The Scorer Class</a>
 *                 below for help defining a Scorer. As the name implies, the Scorer is responsible for doing the actual scoring of documents 
 *                 given the Query.
 *             </li>
 *             <li>
 *                 {@link com.lucene.search.Weight#explain(com.lucene.index.LeafReaderContext, int) 
 ...
 *                 that scores via a {@link com.lucene.search.similarities.Similarity Similarity} will make use of the Similarity's implementation:
 *                 {@link com.lucene.search.similarities.Similarity.SimScorer#explain(Explanation, long) SimScorer#explain(Explanation freq, long norm)}.
 *             </li>
 *             <li>
 *                 {@link com.lucene.search.Weight#extractTerms(java.util.Set) extractTerms(Set&lt;Term&gt; terms)} &mdash; Extract terms that
 ...
 *             </li>
 *             <li>
 *                 {@link com.lucene.search.Weight#matches matches(LeafReaderContext context, int doc)} &mdash; Give information about positions
 ...
 *     <p>The
 *         {@link com.lucene.search.Scorer Scorer}
 *         abstract class provides common scoring functionality for all Scorer implementations and
 *         is the heart of the Lucene scoring process. The Scorer defines the following methods which
 *         must be implemented:
 *         <ol>
 *             <li>
 *                 {@link com.lucene.search.Scorer#iterator iterator()} &mdash; Return a
 *                 {@link com.lucene.search.DocIdSetIterator DocIdSetIterator} that can iterate over all
 *                 document that matches this Query.
 *             </li>
 *             <li>
 *                 {@link com.lucene.search.Scorer#docID docID()} &mdash; Returns the id of the
 *                 {@link com.lucene.document.Document Document} that contains the match.
 *             </li>
 *             <li>
 *                 {@link com.lucene.search.Scorer#score score()} &mdash; Return the score of the
 *                 current document. This value can be determined in any appropriate way for an application. For instance, the
 *                 {@link com.lucene.search.TermScorer TermScorer} simply defers to the configured Similarity:
 *                 {@link com.lucene.search.similarities.Similarity.SimScorer#score(float, long) SimScorer.score(float freq, long norm)}.
 *             </li>
 *             <li>
 *                 {@link com.lucene.search.Scorer#getChildren getChildren()} &mdash; Returns any child subscorers
 ...
 *     <p>The
 *         {@link com.lucene.search.BulkScorer BulkScorer} scores a range of documents.  There is only one 
 *         abstract method:
 *         <ol>
 *             <li>
 *                 {@link com.lucene.search.BulkScorer#score(com.lucene.search.LeafCollector,com.lucene.util.Bits,int,int) score(LeafCollector,Bits,int,int)} &mdash;
 ...
 * <p>In the typical search application, a {@link com.lucene.search.Query Query}
 *    is passed to the {@link com.lucene.search.IndexSearcher IndexSearcher},
 *    beginning the scoring process.
 * <p>Once inside the IndexSearcher, a {@link com.lucene.search.Collector Collector}
 *    is used for the scoring and sorting of the search results.
 *    These important objects are involved in a search:
 *    <ol>                
 *       <li>The {@link com.lucene.search.Weight Weight} object of the Query. The
 ...
 *       <li>A {@link com.lucene.search.Sort Sort} object for specifying how to sort
 ...
 *    {@link com.lucene.search.Weight Weight} object created by
 *    {@link com.lucene.search.IndexSearcher#createWeight(com.lucene.search.Query,ScoreMode,float)
 *     IndexSearcher.createWeight(Query,ScoreMode,float)} and the number of results we want.
 *    This method returns a {@link com.lucene.search.TopDocs TopDocs} object,
 *    which is an internal collection of search results. The IndexSearcher creates
 *    a {@link com.lucene.search.TopScoreDocCollector TopScoreDocCollector} and
 *    passes it along with the Weight to another expert search method (for
 *    more on the {@link com.lucene.search.Collector Collector} mechanism,
 *    see {@link com.lucene.search.IndexSearcher IndexSearcher}). The TopScoreDocCollector
 *    uses a {@link com.lucene.util.PriorityQueue PriorityQueue} to collect the
 ...
 *    is where things get involved. The {@link com.lucene.search.Scorer Scorer} that is returned
 *    by the {@link com.lucene.search.Weight Weight} object depends on what type of Query was
 *    submitted. In most real world applications with multiple query terms, the 
 *    {@link com.lucene.search.Scorer Scorer} is going to be a <code>BooleanScorer2</code> created
 *    from {@link com.lucene.search.BooleanWeight BooleanWeight} (see the section on
 ...
 *   {@link com.lucene.search.DocIdSetIterator#nextDoc DocIdSetIterator.nextDoc()} method. The nextDoc() method advances 
