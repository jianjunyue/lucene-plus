 ...
 * {@link Weight}. <br>
 * {@link com.lucene.index.LeafReader} dependent state should reside in the {@link Scorer}.
 * <p>
 * Since {@link Weight} creates {@link Scorer} instances for a given
 * {@link com.lucene.index.LeafReaderContext} ({@link #scorer(com.lucene.index.LeafReaderContext)})
 ...
 * {@link #scorer(com.lucene.index.LeafReaderContext)}.
 * </ol>
 * 
 * @since 2.9
 */
public abstract class Weight implements SegmentCacheable {
   ...
   * 
   * @param context
   *          the {@link com.lucene.index.LeafReaderContext} for which to return the {@link Scorer}.
   *          
