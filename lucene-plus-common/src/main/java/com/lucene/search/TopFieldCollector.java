...
import com.lucene.search.FieldValueHitQueue.Entry;
import com.lucene.search.MaxScoreAccumulator.DocAndScore;
import com.lucene.search.TotalHits.Relation;
 ...
 * <p>
 * See the {@link #create(com.lucene.search.Sort, int, int)} method
