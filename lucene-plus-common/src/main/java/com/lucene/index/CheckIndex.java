...
import com.lucene.codecs.NormsProducer;
import com.lucene.codecs.PointsReader;
...
import com.lucene.codecs.blocktree.BlockTreeTermsReader;
import com.lucene.document.Document;
import com.lucene.document.DocumentStoredFieldVisitor;
import com.lucene.index.CheckIndex.Status.DocValuesStatus;
...
import com.lucene.search.DocValuesFieldExistsQuery;
import com.lucene.search.LeafFieldComparator;
...
import com.lucene.util.CommandLineUtil;
import com.lucene.util.FixedBitSet;
import com.lucene.util.FutureArrays;
import com.lucene.util.IOUtils;
import com.lucene.util.LongBitSet;
import com.lucene.util.StringHelper;
import com.lucene.util.SuppressForbidden;
import com.lucene.util.Version;
import com.lucene.util.automaton.Automata;
import com.lucene.util.automaton.CompiledAutomaton;
...
public final class CheckIndex implements Closeable {
  ...
  /** Command-line interface to check and exorcise corrupt segments from an index.
    ...
    Run it like this:
    <pre>
    java -ea:com.lucene... com.lucene.index.CheckIndex pathToIndex [-exorcise] [-verbose] [-segment X] [-segment Y]
    </pre>
    <ul>
  ...
  private static int doMain(String args[]) throws IOException, InterruptedException {
    ...
    if (!assertsOn())
      System.out.println("\nNOTE: testing will be more thorough if you run java with '-ea:com.lucene...', so assertions are enabled");
  ...
  public static Options parseOptions(String[] args) {
    ...
    if (opts.indexPath == null) {
      throw new IllegalArgumentException("\nERROR: index path not specified" +
                         "\nUsage: java com.lucene.index.CheckIndex pathToIndex [-exorcise] [-slow] [-segment X] [-segment Y] [-dir-impl X]\n" +
                         "\n" +
