...
class SortingLeafReader extends FilterLeafReader {
  ...
  /** Expert: same as {@link #wrap(com.lucene.index.LeafReader, Sort)} but operates directly on a {@link Sorter.DocMap}. */
