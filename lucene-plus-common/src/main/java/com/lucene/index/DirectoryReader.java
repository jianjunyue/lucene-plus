...
import com.lucene.search.SearcherManager; // javadocs
...
public abstract class DirectoryReader extends BaseCompositeReader<LeafReader> {
   ...
   *  Directory
   * @param directory the index directory
   * @param readerAttributes the reader attributes passed to the {@link com.lucene.codecs.Codec} layer of the
  ...
  /**
   * Open a near real time IndexReader from the {@link com.lucene.index.IndexWriter}.
   *
  ...
  /**
   * Expert: open a near real time IndexReader from the {@link com.lucene.index.IndexWriter},
   ...
   * hit an {@link com.lucene.store.AlreadyClosedException}.</p>
   *
