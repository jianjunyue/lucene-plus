 ...
 */
package com.lucene.queries.function.valuesource;
...
import com.lucene.search.SortedNumericSelector.Type;
import com.lucene.search.SortedNumericSortField;

/**
 * Obtains double field values from {@link com.lucene.index.LeafReader#getSortedNumericDocValues} and using a 
 * {@link com.lucene.search.SortedNumericSelector} it gives a single-valued ValueSource view of a field.
 */
