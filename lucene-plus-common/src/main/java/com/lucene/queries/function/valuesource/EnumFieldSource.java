...
import com.lucene.queries.function.ValueSourceScorer;
import com.lucene.queries.function.docvalues.IntDocValues;
import com.lucene.search.Weight;
import com.lucene.util.mutable.MutableValue;
import com.lucene.util.mutable.MutableValueInt;

/**
 * Obtains int field values from {@link com.lucene.index.LeafReader#getNumericDocValues} and makes
