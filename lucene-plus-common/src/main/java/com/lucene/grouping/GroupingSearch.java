...
import com.lucene.search.CachingCollector;
import com.lucene.search.Collector;
...
public class GroupingSearch {
   ...
   *
   * @param searcher    The {@link com.lucene.search.IndexSearcher} instance to execute the grouped search on.
