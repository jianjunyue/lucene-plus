 ...
 *   com.lucene.grouping.FirstPassGroupingCollector})
 *   gathers the top groups, and the second pass ({@link
 *   com.lucene.grouping.SecondPassGroupingCollector})
 *   gathers documents within those groups.  If the search is costly to
 *   run you may want to use the {@link
 *   com.lucene.search.CachingCollector} class, which
 ...
 *   com.lucene.grouping.TopGroups} instance.</p>
 * 
 * <p>Groups are defined by {@link com.lucene.grouping.GroupSelector}
 *   implementations:</p>
 *   <ul>
 *     <li>{@link com.lucene.grouping.TermGroupSelector} groups based on
 *     the value of a {@link com.lucene.index.SortedDocValues} field</li>
 *     <li>{@link com.lucene.grouping.ValueSourceGroupSelector} groups based on
 *     the value of a {@link com.lucene.queries.function.ValueSource}</li>
 *   </ul>
 * 
