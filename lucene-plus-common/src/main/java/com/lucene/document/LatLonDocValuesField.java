...
import com.lucene.search.FieldDoc;
import com.lucene.search.IndexOrDocValuesQuery;
...
public class LatLonDocValuesField extends Field {
   ...
   * @see com.lucene.geo.GeoEncodingUtils#decodeLatitude(int)
   * @see com.lucene.geo.GeoEncodingUtils#decodeLongitude(int)
   */
