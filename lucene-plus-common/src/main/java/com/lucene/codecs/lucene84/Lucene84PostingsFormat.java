...
import com.lucene.codecs.MultiLevelSkipListWriter;
import com.lucene.codecs.PostingsFormat;
import com.lucene.codecs.PostingsReaderBase;
import com.lucene.codecs.PostingsWriterBase;
import com.lucene.codecs.blocktree.BlockTreeTermsReader;
import com.lucene.codecs.blocktree.BlockTreeTermsWriter;
 ...
 *        a tradeoff. It is also the skip interval used to accelerate {@link com.lucene.index.PostingsEnum#advance(int)}.
...
public final class Lucene84PostingsFormat extends PostingsFormat {
   ...
   * {@link com.lucene.index.PostingsEnum} without re-seeking the terms dict.
   *
   * @lucene.internal
   */
